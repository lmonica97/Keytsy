        ...
        if (!reviews) {
            ...
            return (
                <div className="review-list-container">
                        {reviews.map(review => (
                            <ReviewShow id={review.id} reviewerId={review.reviewer_id} user={review.user.name} date={review.date} comment={review.comment} rating={review.rating} currentUser={user}
